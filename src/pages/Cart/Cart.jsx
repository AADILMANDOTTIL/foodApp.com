...
function Cart() {
  const {CartItems,food_list,Degrement,Ingrement,remove,getTotalAmount}=useContext(StoreContext)
...
return(
 ...
 <div className='mt-[80px] md:flex md:flex-row-reverse flex flex-col-reverse   justify-between gap-10 ' >
   <div className='flex-1 flex flex-col gap-[20px]'>
     ...
     <button className='border-none text-white bg-[#3a2112] w-[200px] text-[13px] p-[6px] my-10 cursor-pointer rounded'>PROCEED TO CHECKOUT</button>
   </div>
