        ...
        <div className='mt-[100px]'>
          ...
          <div className='mt-[80px] md:flex md:flex-row-reverse flex flex-col-reverse   justify-between gap-10 ' >
            <div className='flex-1 flex flex-col gap-[20px]'>
              ...
              <button onClick={() => navigate('/order')} className='border-none text-white bg-black w-[200px] text-[13px] p-3 mb-6 mt-4 cursor-pointer rounded'>PROCEED TO CHECKOUT</button>
            </div>
